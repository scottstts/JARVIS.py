...
JARVIS_TOOL_RUNTIME_TIMEOUT_SECONDS: Final = 135.0
JARVIS_TOOL_RUNTIME_HEALTHCHECK_TIMEOUT_SECONDS: Final = 5.0
JARVIS_TOOL_RUNTIME_SERVICE_HOST: Final = "0.0.0.0"
JARVIS_TOOL_RUNTIME_SERVICE_PORT: Final = 8081
JARVIS_TOOL_BASH_EXECUTABLE: Final = "/bin/bash"
JARVIS_TOOL_BASH_DEFAULT_TIMEOUT_SECONDS: Final = 120.0
JARVIS_TOOL_BASH_MAX_TIMEOUT_SECONDS: Final = 1800.0
JARVIS_TOOL_BASH_FOREGROUND_SOFT_TIMEOUT_SECONDS: Final = 15.0
JARVIS_TOOL_BASH_MAX_OUTPUT_CHARS: Final = 40_000
JARVIS_TOOL_BASH_JOB_LOG_MAX_BYTES: Final = 4 * 1024 * 1024
JARVIS_TOOL_BASH_JOB_TOTAL_STORAGE_BUDGET_BYTES: Final = 128 * 1024 * 1024
JARVIS_TOOL_BASH_JOB_RETENTION_SECONDS: Final = 86_400.0
BASH_DANGEROUSLY_SKIP_PERMISSION: Final = False
JARVIS_TOOL_CENTRAL_PYTHON_VENV: Final = "/opt/venv"
JARVIS_TOOL_CENTRAL_PYTHON_STARTER_PACKAGES: Final[tuple[str, ...]] = (
    "python-dateutil",
    "pyyaml",
    "pymupdf",
    "pandas",
...
JARVIS_TOOL_EMAIL_SMTP_HOST: Final = "smtp.gmail.com"
JARVIS_TOOL_EMAIL_SMTP_PORT: Final = 465
JARVIS_TOOL_EMAIL_SMTP_SECURITY: Final = "ssl"
JARVIS_TOOL_EMAIL_TIMEOUT_SECONDS: Final = 30.0
JARVIS_TOOL_EMAIL_MAX_SUBJECT_CHARS: Final = 200
JARVIS_TOOL_EMAIL_MAX_BODY_CHARS: Final = 20_000
JARVIS_TOOL_EMAIL_MAX_ATTACHMENT_COUNT: Final = 10
JARVIS_TOOL_EMAIL_MAX_TOTAL_ATTACHMENT_BYTES: Final = 20 * 1024 * 1024
...
JARVIS_MEMORY_SEMANTIC_SCORE_FLOOR: Final = 0.30
...
JARVIS_OPENAI_REASONING_EFFORT: Final = "medium"
