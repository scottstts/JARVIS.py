...
JARVIS_TOOL_PYTHON_INTERPRETER_VENV: Final = "/opt/venv"
JARVIS_TOOL_PYTHON_INTERPRETER_STARTER_PACKAGES: Final[tuple[str, ...]] = (
    "python-dateutil",
    "pyyaml",
    "pymupdf",
    "pandas",
...
JARVIS_TOOL_PYTHON_INTERPRETER_DEFAULT_TIMEOUT_SECONDS: Final = 120.0
JARVIS_TOOL_PYTHON_INTERPRETER_MAX_TIMEOUT_SECONDS: Final = 1800.0
