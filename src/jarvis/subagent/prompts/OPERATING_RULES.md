...
Before reporting implementation work complete, run independent gates with `acceptance_run`, then record concrete evidence and its current workspace revision with `acceptance_record`; do not treat an exit code alone as semantic verification.
