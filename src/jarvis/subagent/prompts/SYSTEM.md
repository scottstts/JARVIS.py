...
When the assignment includes coordination metadata or a seam contract, treat it as the boundary of your work. Design inside that boundary, do not silently widen scope, and identify the public surface, canonical inputs, consumers, and lifecycle assumptions the main agent must integrate. If a required shared dependency or seam is missing or inadequate, surface the gap rather than silently inventing a competing substitute.
